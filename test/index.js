...
console.log('📌 7. createTag / createStyle');
...
// ─── 8. render with Style Object ──────────────
console.log('📌 8. render(text, style)');
const result = dye.render('Hello World', { fg: 'green', bold: true });
...
// ─── 10. Only Style (no text) ────────────────
console.log('📌 10. Only Style (returns ANSI codes)');
